...
@section('content')
	...
	<div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
		<div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
			...
			@endif
			<form class="auth-reset-password-form mt-2" action="{{ route('agent.password.update') }}" method="POST" novalidate="novalidate">
				@csrf
