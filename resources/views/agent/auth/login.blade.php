@extends('layouts.auth.agent_auth')
...
@section('content')
	...
	<div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
		<div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
			<h1 class="card-title font-weight-bold mb-1" style="text-align: center;"><b>Agent Login</b></h1>
			...
			@endif
			<form class="auth-login-form mt-2" action="{{ route('agent.login') }}" method="POST">
				@csrf
				<div class="form-group">
					<label class="form-label" for="login-email">Email<span style="color: red;">*</span></label></label>
				...
				<div class="form-group">
					<div class="d-flex justify-content-between">
						<label for="login-password">Password</label><a href="{{route('agent.password.request')}}"><small>Forgot Password?</small></a>
					</div>
