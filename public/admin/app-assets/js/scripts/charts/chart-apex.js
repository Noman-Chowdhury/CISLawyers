...
$(function () {
  ...
  if (flatPicker.length) {
    ...
    flatPicker.each(function () {
      $(this).flatpickr({
        mode: 'range',
        defaultDate: ['2019-05-01', '2019-05-02']
      });
    });
  }
  ...
  var radialBarChartEl = document.querySelector('#radialbar-chart'),
    radialBarChartConfig = {
      ...
      // series: [80, 50, 35, 60,70.60,30],
      series: [80, 50, 35, 60, 30, 70, 50, 70],
      labels: ['Dhaka', 'Chittagong', 'Barisal','khulna','Mymensingh','Rajshahi','Rangpur','Sylhet']
    };
