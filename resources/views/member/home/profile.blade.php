...
@section('breadcrumb')
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('member.home') }}">{{__('Home')}}</a></li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="account-vertical-general"
                                        ...
                                        <form class="validate-form mt-2" novalidate="novalidate" method="post"
                                              action="{{route('member.update.general')}}"
                                              enctype="multipart/form-data">
                                            @csrf
                                            <div class="media">
                                                <a href="javascript:void(0);" class="mr-25">
                                                    @if($data->profile_image)
                                                        <img src="{{asset(config('imagepath.member-profile').auth('member')->user()->profile_image ?? '')}}"
                                                             id="blah"
                                                ...
                                                <div class="media-body mt-75 ml-1">
                                                    <div class="col-12 d-flex mt-1 px-0">
                                                        <label
                                                            ...
                                                            for="change-picture">
                                                            <span class="d-none d-sm-block">{{__('Profile')}} </span>
                                    ...
                                    <div class="tab-pane fade" id="account-vertical-password" role="tabpanel"
                                        ...
                                        <form class="validate-form" novalidate="novalidate" id="change_password"
                                              method="post"
                                              action="{{route('member.update.password')}}">
                                            @csrf
