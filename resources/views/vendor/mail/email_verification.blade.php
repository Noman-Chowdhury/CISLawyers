...
<p style="margin: 0 0 24px;">
    ...
    <a href="mailto:john@example.com" class="hover-underline" style="--text-opacity: 1; color: #7367f0; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">shamim@example.com</a>
    (ID: 8632698) from the IP - <span style="font-weight: 600;">49.34.185.199</span> . </p>
<p style="margin: 0 0 24px;">Use this link to reset your password and login.</p>
<a href="https://pixinvent.com/?reset_password_url" style="display: block; font-size: 14px; line-height: 100%; margin-bottom: 24px; --text-opacity: 1; color: #7367f0; color: rgba(115, 103, 240, var(--text-opacity)); text-decoration: none;">https://sourcesbd.com?email_verification_url</a>
<table style="font-family: 'Montserrat',Arial,sans-serif;" role="presentation">
    <tr>
        <td style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #7367f0; background-color: rgba(115, 103, 240, var(--bg-opacity)); border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;" bgcolor="rgba(115, 103, 240, var(--bg-opacity))">
            <a href="https://pixinvent.com/?reset_password_url" style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; --text-opacity: 1; color: #ffffff; color: rgba(255, 255, 255, var(--text-opacity)); text-decoration: none;">Email-Verification &rarr;</a>
        </td>
    </tr>
</table>
